...
<body>
    <div class="box">
        <div>
            <button type="button" class="returnBtn" onclick="location.href='/cancel'">⇦キャンセル</button>
        </div>
        <h3 class="deletenewpasstitle">仮のIDとパスワードを作成します。</h3>
        <form action="DeleteNewPass" method="post">
            {{ csrf_field() }}
            ...
            <div>
                ...
                <input type="button" class="NewPassReturn" onclick="location.href='/login'" value="ログイン画面">
            </div>
        </form>
